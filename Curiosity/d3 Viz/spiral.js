...
//https://bl.ocks.org/arpitnarechania/027e163073864ef2ac4ceb5c2c0bf616 - some part of the code were taken from here.
d3.text("actions.csv", function(text) {
    ...
    d3.text("rewards.csv", function(text) {
