d3.text("actions_2.csv", function(text) {
    ...
    d3.text("rewards_2.csv", function(text) {
        ...
        plot_sp2(data, r_data, 0)

        })
    })


function get_graph_2(n){
    console.log(n)
    d3.selectAll("#sp2 svg").remove();
...
function plot_sp2(data, r_data,n){
    var width = 500,
    height = 500,
    start = 0,
    end = 2.25,
    ...
    var svg2 = d3.select("#sp2").append("svg")
        .attr("width", width)
        .attr("height", height)
        .append("g")
